...
<% 
	if(request.getParameter("go2") != null)
        {			
			...
			out.println("<br><FORM ACTION='afterdataAnalysis2.jsp' METHOD='post' ><input type='checkbox' name='name1'>Name<input type='checkbox' name='type'>Test Type<br>");
			out.println("<input type='checkbox' name='year'>Year<input type='checkbox' name='month'>Month<input type='checkbox' name='week'>Week<br>");
